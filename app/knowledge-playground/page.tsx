      ...
      children: [
        {
          ...
          children: [
            {
              id: 'app-playground-slug',
              label: '[slug]',
              type: 'folder' as const,
              children: [
                { id: 'app-playground-slug-not-found', label: 'not-found.tsx', type: 'file' as const },
                { id: 'app-playground-slug-page', label: 'page.tsx', type: 'file' as const },
              ],
            },
            { id: 'app-playground-page', label: 'page.tsx', type: 'file' as const },
          ],
        },
        {
          id: 'app-knowledge-playground',
          label: 'knowledge-playground',
          type: 'folder' as const,
          children: [{ id: 'app-knowledge-playground-page', label: 'page.tsx', type: 'file' as const }],
        },
        {
          id: 'app-poetry',
          label: 'poetry',
