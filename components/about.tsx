...
const statements = [
  "I design interfaces where AI feels intuitive.",
  "Bridging human cognition and machine intelligence.",
  "Every prompt is a conversation with intent.",
  ...
  return (
    <section id="about" ref={containerRef} className="relative py-32 overflow-hidden md:py-0">
      ...
      >
        ...
        <h2 className="font-sans text-3xl md:text-5xl font-light italic">Design Principles</h2>
      </motion.div>

      <div className="relative flex items-center overflow-hidden py-0 gap-0 h-24 md:h-28">
